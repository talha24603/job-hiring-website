...
function VideoUpload() {
  ...
  const [imageUrl, setImageUrl] = useState('') // Renamed setter for clarity
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await axios.post("/api/employee-data-upload", formData)
