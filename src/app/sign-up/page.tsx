      ...
      <div className="w-full max-w-md px-4">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
          <Card className="w-full overflow-hidden border-0 shadow-xl">
            ...
            {/* Alert about Google sign-up limitation */}
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-lg p-3">
                <div className="flex items-start gap-2">
                  ...
                  <div className="text-sm text-amber-800">
                    <p className="font-medium">Credentials Sign-up Limited</p>
                    <p className="text-amber-700 mt-1">
                      Credentials sign-up may not be available for all users due to our free Resend email package limitations. 
                      Please use the google registration for guaranteed access.
                    </p>
                  </div>
                </div>
              </div>
